...
namespace Cbd.MobileExperienceApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AcctAcctTrnInq_response_AcctAcctTrnInqRs_AcctTrnRec_inner_AcctTrnInfo_IssuedIdent_inner")]
    public partial class AcctAcctTrnInqResponseAcctAcctTrnInqRsAcctTrnRecInnerAcctTrnInfoIssuedIdentInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcctAcctTrnInqResponseAcctAcctTrnInqRsAcctTrnRecInnerAcctTrnInfoIssuedIdentInner" /> class.
        /// </summary>
        /// <param name="issuedIdentType">issuedIdentType.</param>
        /// <param name="issuedIdentValue">issuedIdentValue.</param>
        public AcctAcctTrnInqResponseAcctAcctTrnInqRsAcctTrnRecInnerAcctTrnInfoIssuedIdentInner(string issuedIdentType = default(string), string issuedIdentValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AcctAcctTrnInqResponseAcctAcctTrnInqRsAcctTrnRecInnerAcctTrnInfoIssuedIdentInner {\n");
