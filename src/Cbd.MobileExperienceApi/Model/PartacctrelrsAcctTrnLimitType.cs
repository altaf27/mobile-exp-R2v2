...
{
    /// <summary>
    /// PartacctrelrsAcctTrnLimitType
    /// </summary>
    [DataContract(Name = "partacctrelrs_AcctTrnLimit_Type")]
    public partial class PartacctrelrsAcctTrnLimitType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartacctrelrsAcctTrnLimitType" /> class.
        /// </summary>
        /// <param name="limitType">limitType.</param>
        /// <param name="curAmt">curAmt.</param>
        public PartacctrelrsAcctTrnLimitType(string limitType = default(string), PartacctrelrsCurAmtType curAmt = default(PartacctrelrsCurAmtType))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartacctrelrsAcctTrnLimitType {\n");
