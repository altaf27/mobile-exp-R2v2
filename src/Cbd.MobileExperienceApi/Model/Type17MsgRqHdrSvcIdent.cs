...
{
    /// <summary>
    /// Type17MsgRqHdrSvcIdent
    /// </summary>
    [DataContract(Name = "type_17_MsgRqHdr_SvcIdent")]
    public partial class Type17MsgRqHdrSvcIdent : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Type17MsgRqHdrSvcIdent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Type17MsgRqHdrSvcIdent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Type17MsgRqHdrSvcIdent" /> class.
        /// </summary>
        ...
        public Type17MsgRqHdrSvcIdent(string svcProviderName = default(string), string svcProviderId = default(string), string svcName = default(string))
        {
            // to ensure "svcProviderName" is required (not null)
            if (svcProviderName == null)
            {
                throw new ArgumentNullException("svcProviderName is a required property for Type17MsgRqHdrSvcIdent and cannot be null");
            }
            this.SvcProviderName = svcProviderName;
            // to ensure "svcProviderId" is required (not null)
            if (svcProviderId == null)
            {
                throw new ArgumentNullException("svcProviderId is a required property for Type17MsgRqHdrSvcIdent and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Type17MsgRqHdrSvcIdent {\n");
