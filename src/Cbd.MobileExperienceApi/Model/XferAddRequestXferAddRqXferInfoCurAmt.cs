...
{
    /// <summary>
    /// XferAddRequestXferAddRqXferInfoCurAmt
    /// </summary>
    [DataContract(Name = "XferAdd_request_XferAddRq_XferInfo_CurAmt")]
    public partial class XferAddRequestXferAddRqXferInfoCurAmt : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XferAddRequestXferAddRqXferInfoCurAmt" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected XferAddRequestXferAddRqXferInfoCurAmt() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="XferAddRequestXferAddRqXferInfoCurAmt" /> class.
        /// </summary>
        ...
        public XferAddRequestXferAddRqXferInfoCurAmt(decimal amt = default(decimal), string acctType = default(string), XferAddRequestXferAddRqXferInfoToAcctRefAcctKeysCurCode curCode = default(XferAddRequestXferAddRqXferInfoToAcctRefAcctKeysCurCode))
        {
            this.Amt = amt;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XferAddRequestXferAddRqXferInfoCurAmt {\n");
